...
extern volatile int *OutPort_HEX012;
extern volatile int *OutPort_HEX345;
extern volatile int *UART;
extern volatile int *UART_status;

extern volatile char rx_buffer[];
extern volatile int rx_index;
extern volatile int rx_ready; // flag for main to process
extern volatile char debug_char;
extern volatile int debug_ready;
extern volatile int debug_raw;
...
void interrupt_handler(void)
{
    ...
    {
    	alt_putstr("uart\n");
    	volatile int *uart_rx   = (volatile int *) 0x04009000;
		volatile int *uart_stat = (volatile int *) 0x04009008;
