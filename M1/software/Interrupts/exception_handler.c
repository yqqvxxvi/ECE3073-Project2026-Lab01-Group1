...
extern int* OutPort_LEDR;  // this is the 8 LED same variable followed as in main
...
/// IMPORTANT STATEMENT HERE write code that will clear edge capture register of COUNTER MSB
// Write code to check whether irq0 level interrupt occurd ( like if statement)
