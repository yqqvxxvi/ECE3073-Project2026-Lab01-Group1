...
# Memory: CORE_RAM1
MEM_0 := dual_processor_CORE_RAM1
$(MEM_0)_NAME := CORE_RAM1
...
$(MEM_0)_END := 0x02019fff
$(MEM_0)_SPAN := 0x0000a000
$(MEM_0)_HIERARCHICAL_PATH := CORE_RAM1
$(MEM_0)_WIDTH := 32
...
.PHONY: CORE_RAM1
CORE_RAM1: check_elf_exists $(MEM_INIT_DIR)/$(MEM_0).hex $(HDL_SIM_DIR)/$(MEM_0).dat $(HDL_SIM_DIR)/$(MEM_0).sym

# Memory: SHARED_SDRAM
MEM_1 := SHARED_SDRAM
$(MEM_1)_NAME := SHARED_SDRAM
...
$(MEM_1)_HIERARCHICAL_PATH := SHARED_SDRAM
$(MEM_1)_WIDTH := 16
...
.PHONY: SHARED_SDRAM
SHARED_SDRAM: check_elf_exists $(HDL_SIM_DIR)/$(MEM_1).dat $(HDL_SIM_DIR)/$(MEM_1).sym
