...
$(MEM_1)_END := 0x00019fff
$(MEM_1)_SPAN := 0x0000a000
$(MEM_1)_HIERARCHICAL_PATH := ram2
$(MEM_1)_WIDTH := 32
...
.PHONY: ram2
ram2: check_elf_exists $(MEM_INIT_DIR)/$(MEM_1).hex $(HDL_SIM_DIR)/$(MEM_1).dat $(HDL_SIM_DIR)/$(MEM_1).sym
