...
volatile int *ACCEL               = (volatile int *) (ACCELEROMETER_SPI_0_BASE | 0x80000000);
volatile int *SPI_RxData          = (volatile int *) (SPI_0_BASE | 0x80000000);
volatile int *SPI_TxData          = (volatile int *) ((SPI_0_BASE + 0x4) | 0x80000000);
...
void generate_text_image_to_sdram(const char *reading)
{
