...
$(MEM_0)_HIERARCHICAL_PATH := SHARED_SDRAM
$(MEM_0)_WIDTH := 16
...
.PHONY: SHARED_SDRAM
SHARED_SDRAM: check_elf_exists $(HDL_SIM_DIR)/$(MEM_0).dat $(HDL_SIM_DIR)/$(MEM_0).sym

# Memory: ram1
MEM_1 := DualProcessorPeri_ram1
$(MEM_1)_NAME := ram1
...
$(MEM_1)_START := 0x02010000
$(MEM_1)_END := 0x02019fff
$(MEM_1)_SPAN := 0x0000a000
$(MEM_1)_HIERARCHICAL_PATH := ram1
$(MEM_1)_WIDTH := 32
...
.PHONY: ram1
ram1: check_elf_exists $(MEM_INIT_DIR)/$(MEM_1).hex $(HDL_SIM_DIR)/$(MEM_1).dat $(HDL_SIM_DIR)/$(MEM_1).sym
